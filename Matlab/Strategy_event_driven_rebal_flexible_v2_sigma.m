function [r, num_aportaciones, valor_final_total, detalle] = Strategy_event_driven_rebal_flexible_v2_sigma( ...
...
% ---------- Defaults ----------
if nargin < 3 || isempty(tickers_config), error('Debes especificar los tickers del portfolio'); end
if nargin < 4 || isempty(weights_config), weights_config = ones(1, length(tickers_config)) / length(tickers_config); end
...
if num_activos == 1, TT = TT_list{1}; else, TT = synchronize(TT_list{:}, 'intersection'); end
...
acciones_struct = struct(); valores_struct = struct();
for i = 1:num_activos
...
if ~debug
    fprintf('=====================================================================================================================\n');
    fprintf('Portfolio Event-Driven + Reb. SUAVE v2 (NO MA filter) (%s) | %d anos | CAGR: %.2f%% | Aportes: %d | Valor final: %.2f\n', ...
    ...
    fprintf('=====================================================================================================================\n');
    fprintf('Portfolio Event-Driven + Rebalanceo SUAVE v2 - SIN FILTRO MA_reb\n');
    ...
    fprintf('Senal: z<=%.2f & Px<MMsig(%d) | Receptores: TODOS (sin filtro MA_reb)\n', z_threshold, MA_sig);
