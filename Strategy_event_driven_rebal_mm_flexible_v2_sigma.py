...
def Strategy_event_driven_rebal_mm_flexible_v2_sigma(
    ...
    if not debug:
        print('=' * 117)
        print('Portfolio Event-Driven + Reb. SUAVE v2 (MMrec) (%s) | %d anos | CAGR: %s%% | Aportes: %d | Valor final: %s'
        ...
        print('=' * 117)
        print('Portfolio Event-Driven + Rebalanceo SUAVE con MM v2 - SIN LIMITES DE CAPITAL')
